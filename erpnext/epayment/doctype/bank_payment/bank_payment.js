...
var enable_disable = function(frm){
	var permitted_doctypes = ['Bonus', 'Employee Loan Payment', 'LTC', 'PBVA', 'Salary','Employee PF Payment'];
	frm.toggle_display(['fiscal_year', 'region', 'employee', 'department', 'division'], permitted_doctypes.includes(frm.doc.transaction_type));
	frm.toggle_display(['month'], ['Employee Loan Payment', 'Salary','Employee PF Payment',].includes(frm.doc.transaction_type));
	...
	frm.toggle_reqd(['month'], ['Employee Loan Payment', 'Salary','Employee PF Payment'].includes(frm.doc.transaction_type));
