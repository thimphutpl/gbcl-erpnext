    ...
    refresh: (frm) => {
        ...
        if (frm.doc.docstatus == 1) {
            ...
            frappe.db.get_list("Review", {
                ...
                let review_types = reviews.map(r => r.review_type);
                // alert(review_types)

                // All Review I-IV completed
                if (
                    review_types.includes("Review I")
                ) {
