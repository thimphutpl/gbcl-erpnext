...
class PerformanceEvaluation(Document):
	...
	def calculate_competency_score(self):
		...
		rating_ii =  flt(self.evaluate_competency_item[indx].average) / flt(self.evaluate_competency_item[indx].weightage)
		# self.form_ii_total_rating = flt(rating_ii) * self.competency_total_weightage
		# frappe.throw(str(flt(self.evaluate_competency_item[indx].average)))
		self.form_ii_total_rating = flt(rating_ii) * 50
		self.db_set('form_ii_total_rating', self.form_ii_total_rating)
	...
	def calculate_final_score(self):
		...
		# frappe.throw(str(self.overall_rating))
