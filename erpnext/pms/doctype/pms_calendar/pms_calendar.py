...
class PMSCalendar(Document):
	...
	if TYPE_CHECKING:
		...
		review_ii_end_date: DF.Date
		review_ii_start_date: DF.Date
		review_iii_end_date: DF.Date
		review_iii_start_date: DF.Date
		review_iv_end_date: DF.Date
		review_iv_start_date: DF.Date
