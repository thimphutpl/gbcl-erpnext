...
# 								""", (filters.month, d.account, d.cost_center, filters.company, from_date, to_date))[0][0], 2)
...
# 									where to_month = %s
# 									and to_account = %s
# 									and to_cost_center = %s
# 									and company = %s
# 								""", (filters.month, d.account, d.cost_center, filters.company))[0][0]
...
# 			""", (d.cost_center, d.account, filters.company, from_date, to_date))[0][0]
...
# 				and company = %s
# 				and reference_date BETWEEN %s and %s
# 			""", (d.account, filters.company, filters.from_date, filters.to_date))[0][0]
...
# 				and company = %s
# 				and reference_date BETWEEN %s and %s
# 			""", (d.cost_center, d.project, filters.company, filters.from_date, filters.to_date))[0][0]
...
# 				and company = %s
# 				and reference_date BETWEEN %s and %s
# 			""", (d.cost_center, d.account, filters.company, filters.from_date, filters.to_date))[0][0]
...
# 		condition += " and b.cost_center = '{}' ".format(filters.cost_center)
		
# 	if filters.budget_type:
# 		condition += " and ba.budget_type = '{}' ".format(filters.budget_type)
...
# 	if filters.monthly_budget and filters.month:
# 		month_field_name = filters.month.lower()
...
# 		{condition}
# 		""".format(fiscal_year=filters.fiscal_year, condition=condition, month_name=month_field_name)
# 	else:
# 		query = """select b.cost_center, ba.account, b.project,
# 			(select a.account_number from `tabAccount` a where a.name = ba.account) as account_number, 
# 			ba.budget_type,
