...
class Asset(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from erpnext.assets.doctype.income_depreciation_schedule.income_depreciation_schedule import IncomeDepreciationSchedule
		...
		id_schedules: DF.Table[IncomeDepreciationSchedule]
